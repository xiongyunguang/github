...
<head>
<title>医院管理系统</title>
<link href="abc/css1/left_css.css" rel="stylesheet" type="text/css">
</head>
...
<body bgcolor="16ACFF">
	...
	<table width="98%" border="0" cellpadding="0" cellspacing="0"
			...
			<td>
				<TABLE class=leftframetable cellSpacing=0 cellPadding=0 width="97%"
					...
					<TBODY>
						<TR>
							<TD height="25"
								style="background: url(abc/left_tt.gif) no-repeat">
		...
		<tr>
			<td height="5" background="abc/tableline_bottom.jpg"
				bgcolor="#9BC2ED"></td>
		</tr>
		<tr>
			<td height="5" background="abc/tableline_top.jpg"
		...
		<tr>
			<td height="5" background="abc/tableline_bottom.jpg"></td>
		</tr>
	</table>
</body>
</html>