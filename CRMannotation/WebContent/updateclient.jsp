...
<html>
	<body>
 	...
 	<link type="text/css" rel="stylesheet" media="all" href="abc/css1/ioa.css" />
	<!-- <script type="text/javascript" src="abc/calendar/WdatePicker.js"></script>
	 -->
	<script type="text/javascript" src="abc/jquery-2.1.4.js"></script>
					...
					<td valign="top" align="left" class="pad5">
						...
						<table width="100%" border="0" cellpadding="1" cellspacing="1"
							...
							<tr>
								...
								<td width="36%" align="left" class="even padl5">
									<input type=text name="cphone" id="cphone" required="required" maxlength="32" class="inputnormal"
							...
							<tr>
								...
								<td width="36%" align="left" class="even padl5">
									<input type=text name="cemail" id="cemail" required="required" maxlength="32"
