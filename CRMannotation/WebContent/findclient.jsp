  ...
  <tr>
	<td valign="top" align="left" class="pad5">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="dqbg margb5">
          <tr>
            <td width="2%" align="right" class="pad05"><img src="abc/img2.gif" width="16" height="16"></td>
        ...
        <!----------------------------   新增按钮 ------------------------------------------->
            ...
            <td width="61" align="left" class="padr5"><input type="image" src="abc/pic-13.jpg" onClick="window.location.href='addclient.jsp'"></td>
	    ...
	    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="table-border margb5">
		  <tr>
			<td colspan="11" align="left" class="tabbg"><img src="abc/main_pic_1.gif" align="absmiddle" width="16" height="16">&nbsp;<span class="lan13b"></span></td>
	      </tr>
